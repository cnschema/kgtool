...
class CnsSchema:
    ...
    def _build_index_template(self, available_schema_list):
        ...
        for schema in available_schema_list:
            for template in schema.metadata["template"]:
                ...
                #     else:
                #         template_new = {}
                #         template_new["propertyRange"]= {
                #               "text": d,
                #               "python_type_value_list":[],
                #               "cns_range_entity":[d],
                #               "cns_range_datastructure":[]
                #         }
    ...
    def import_jsonld(self, filename=None, preloaded_schema_list=None):
        # reset data
    ...
    def import_jsonld_content(self, jsonld, preloaded_schema_list=None):
        # load
